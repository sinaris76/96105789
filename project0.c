...
int counter;
            ...
            if(array[Xpnow][Ypnow]=='*')
                score+=1;
            else if(array[Xpnow][Ypnow]=='^'){

                score+=20;}
            else if(array[Xpnow][Ypnow]=='O') {
                for (counter = 0; counter < 4; counter++)
                    rooh[counter].halat = 0;
            }

    for(counter=0;counter<4;counter++){
        if(rooh[counter].XGnow==Xpnow && rooh[counter].YGnow==Ypnow){
            if(rooh[counter].halat==0){
                score+=50;
            }
        }
...
void Win(int n , struct Ghost rooh[4], int m , int heart, char array[100][100], int Xpnow, int Ypnow){
    ...
    for(count=0 ; count<4 ; count++){
        if(rooh[count].XGnow==Xpnow && rooh[count].YGnow==Ypnow && rooh[count].halat==1)
            heart--;
    }
    ...
    if(array[Xpnow][Ypnow]=='*'|| array[Xpnow][Ypnow]=='O')
    tedad--;
